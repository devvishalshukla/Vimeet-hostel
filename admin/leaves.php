       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    ...
                    <div class="col lg4 s12">
                         <form action="leaves-data.php" method="post">
