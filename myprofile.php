...
<?php 
$eid=$_SESSION['emplogin'];
$sql = "SELECT * from  tblstudents where EmailId=:eid";
$query = $dbh -> prepare($sql);
...
<input id="phone" name="phone" type="tel" value="<?php echo htmlentities($result->Phonenumber);?>" maxlength="10" autocomplete="off" required>
 </div>
...
<input id="RoomNo" name="RoomNo" type="text" value="<?php echo htmlentities($result->RoomNo);?>" readonly autocomplete="off" required>
 </div>

<div class="input-field col m6 s12">
<label for="MessType">Mess Type</label>
<input id="MessType" name="MessType" type="text" value="<?php echo htmlentities($result->MessType);?>" autocomplete="off" required readonly>
 </div>
...
<input id="BusId" name="BusId" type="text" value="<?php echo htmlentities($result->BusId);?>" readonly autocomplete="off" required>
 </div>

  <div class="input-field col m6 s12">
<label for="BusName">Bus Name</label>
<input id="BusName" name="BusName" type="text" value="<?php echo htmlentities($result->BusName);?>" readonly autocomplete="off" required>
 </div>

  <div class="input-field col m6 s12">
<label for="College">College Name</label>
<input id="college" name="college" type="text" value="<?php echo htmlentities($result->college);?>" readonly autocomplete="off" required>
 </div>

  <div class="input-field col m6 s12">
<label for="year">Year</label>
<input id="year" name="year" type="text" value="<?php echo htmlentities($result->year);?>" readonly autocomplete="off" required>
 </div>

  <div class="input-field col m6 s12">
<label for="department">Department</label>
<input id="department" name="department" type="text" value="<?php echo htmlentities($result->department);?>" readonly autocomplete="off" required>
 </div>
